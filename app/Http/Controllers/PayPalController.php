...
class PaypalController extends Controller
{
    ...
    {        
        ...
        if ($result->getState() == 'approved') {         
           ...
           $paid->amount =  \Session::get('amount');
           $paid->stripeToken = null;
           $paid->status='succeeded';
           $paid->paypal_payer = \Session::get('paypal_payment_id');
           $paid->payment_method='paypal';
           $paid->save();
        ...
        \Session::put('error','Payment failed !!');
		return Redirect::route('chchose_paymentose');
    }
}
    ...
    <div class="col-lg-10">
        <div class="card">
            <div class="card-body">        
                ...
                <form action="{{ route('section3.store')}}" method="post" enctype="multipart/form-data">
                    @csrf 
                    <div class="row">
                        <div class="col-lg-8">
                         ...
                         <div class="form-group">
                            <img src="{{('https://aas-bucket.s3.amazonaws.com/uploads/'.@$secion->image)}}"  style="width: 100px" class="img-thumbnail image-preview" data-preview="image" alt="">
                        </div>
                        <div class="col-lg-8">
                            <div class="form-group row">
                                <label for="example-text-input" class="col-sm-2 col-form-label text-right">Section Title</label>
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="title_section" value="{{@$secion->title_section}}"  required >
                                </div>
                            </div>                    
                        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="text" name="title" value="{{@$secion->title}}"  required >
                                </div>
                            </div>                    
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <textarea id="elm1" name="dec">{{@$secion->dec}}</textarea>
                                </div>
                            </div>                    
                        </div>
